    ...
    <div class="container-fluid px-4">
        <div class="heading-contianer d-flex justify-content-between align-items-center">
            <div class="page-details">
                <h1 class="mt-4 dash-heading">Artikel Video</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Artikel Video / Edit</li>
                </ol>
            </div>
        ...
        <div class="user-edit-container">
            <?php
            if (isset($_GET['video_article_id']) || isset($_GET[''])) :
            ?>
                <div class="row g-3">
                    <div class="col-6">
...
<?php
                ...
                $_SESSION['message'] = "Terjadi Kesalahan [ID Artikel Video tidak didefinisikan!]";
                $_SESSION['icon'] = 'error';
                    ...
                    $.each(response, function(index, value) {
                        let html = `
                            <form action="code.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <input type="hidden" value="${value['']}" name="category_name" class="getCategoryName">
